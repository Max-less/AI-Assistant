...
export function Composer({
  ...
  return (
    <div className="pointer-events-none absolute bottom-0 left-0 z-10 flex w-full justify-center bg-gradient-to-t from-bg-tint via-bg-tint to-transparent px-4 pb-6 pt-10 md:px-8">
